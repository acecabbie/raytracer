...
def trace_ray(ray_origin, ray_dir, spheres, x, y, depth=1, max_bounces=10,spheret=None):
        ...
        if t and t < nearest_t:
            ...
            for light_direction, light_color in zip(gpusettings.light_directions, gpusettings.light_colors):
                ...
                if not in_shadow:
                    ...
                    if (x == pixelTestx and y == pixelTesty):
                        print("sphere index: ",sphere.index,"color before shininess loop: ", final_color*255, "depth current: ", depth)
            # Reflections
            if sphere.shininess and max(sphere.shininess) > 0 and depth < max_bounces:
                if depth < max_bounces:
                    ...
                    reflection_color = trace_ray(P + normal * epsilon, reflection_dir, spheres, x, y, depth + 1, max_bounces,sphere) / 255
